...
Story Area  
==============================-->
<div class="story-area-1 overflow-hidden <?php echo $klass;?>">
    <div class="container">
            ...
            <div class="col-xl-7">
                <div class="story-img-box1">
                    ...
                    <div class="story-card movingX">
                        ...
                        real life impact of your pamarions &
            ...
            <div class="col-xl-5">
                <div class="story-wrap1">
                    <div class="title-area mb-0">
                        ...
                        <p class="mt-30">Our secure online pamarion platform allows you to make contributions quickly and safely. Choose from various payment methods and set up one-time.exactly.</p>
