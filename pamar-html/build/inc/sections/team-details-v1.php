        ...
        <div class="teamDetails">
            ...
            <div class="col-xxl-8 col-xl-8">
                <div class="page-single">
                   ...
                   <div class="checklist list-three-column style5 mb-50 mt-35">
                        <ul>
        ...
        <div class="row gx-40 gy-40">
            <div class="col-xxl-8 col-xl-8">
                <div class="box-content">
                    ...
                    <p class="mb-20">The culmination of this transformative endeavor marked the dawn of a new era for the office space, where meticulous attention to detail and an unwavering commitment to excellence converged to create an environment that transcended mere functionality.</p>
                    <p class="mb-50">Through an intricate and strategic overhaul of the office's electrical infrastructure, our dedicated team orchestrated a symphony of technological innovation and precision engineering,</p>
                </div>
                <div class="skill-wrap">
                    <div class="skill-feature style3">
                        <div class="skill-feature">
                            <h3 class="skill-feature_title">High Engagement <span>90%</span></h3>
                            <div class="progress">
                                <div class="progress-bar bg-theme" style="width: 90%;"></div>
                            </div>
                        </div>
                    </div>
                    <div class="skill-feature style3">
                        <div class="skill-feature">
                            <h3 class="skill-feature_title">Effective Project Manage <span>80%</span></h3>
                            <div class="progress">
                                <div class="progress-bar bg-theme" style="width: 80%;"></div>
                            </div>
                        </div>
                    </div>
                    <div class="skill-feature style3">
                        <div class="skill-feature">
                            <h3 class="skill-feature_title">Consulting & Planning <span>85%</span></h3>
                            <div class="progress">
                                <div class="progress-bar bg-theme" style="width: 85%;"></div>
                            </div>
                        </div>
                    </div>
                    <div class="skill-feature style3">
                        <div class="skill-feature">
                            <h3 class="skill-feature_title">High Communication Skilled <span>95%</span></h3>
                            <div class="progress">
                                <div class="progress-bar bg-theme" style="width: 95%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
