...
Process Area  
==============================-->
<section class="position-relative <?php echo $klass;?>" data-bg-src="assets/img/shape/bg-shape5.png">
    <div class="container">
        <div class="row">
            <div class="col-xxl-4">
                <div class="title-area mb-60">
                    <span class="sub-title style2 text-theme2 border-theme2 text-anim after-none before-none"
                     data-cue="slideInLeft">Work Process</span>
                    <h2 class="sec-title style3 text-white text-anim2" data-cue="slideInLeft">
                        How We Work!
                    </h2>
                </div>
            </div>
